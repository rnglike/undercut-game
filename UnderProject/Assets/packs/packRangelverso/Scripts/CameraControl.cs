...
public class CameraControl : MonoBehaviour
{
	...
	void Update()
	{
		...
		else
		{
			...
			if(building.spawned)
			{
				...
				if(escolherModos == modos.DevTeclado)
				{
				...
				if(escolherModos == modos.DevMouse)
				{
					if
					(
	...
	private void SortCameraBehaviour()
	{
		...
		{
			pointA = new Vector3((virtualCurrentRoom.position.x),(virtualCurrentRoom.position.y - 16),(virtualCurrentRoom.position.z));
			pointC = new Vector3((virtualCurrentRoom.position.x),(virtualCurrentRoom.position.y + 18),(virtualCurrentRoom.position.z));
		...
		{
			evidencePoint = new Vector3(virtualCurrentRoom.position.x,virtualCurrentRoom.position.y - 2,virtualCurrentRoom.position.z);
