...
public class Interior : MonoBehaviour
{
	...
	GameObject DecidePart(Transform place,Transform level,string exclude = "none")
	{
		...
		{
			if((choosenPart.name == "Aberto") || (choosenPart.name == "Aberto Small"))
			{
			...
			else if((choosenPart.name == "Fechado") || (choosenPart.name == "Fechado Small"))
			{
				place.name = "Fechado";
				return choosenPart;
			}
			else if((choosenPart.name == "Wall Small") || (choosenPart.name == "Fragile Wall Small"))
			{
